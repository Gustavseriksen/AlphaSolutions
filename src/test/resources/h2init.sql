...
INSERT INTO ProjectManagers (username, password)
VALUES ('PM_bert', '123');
INSERT INTO ProjectManagers (username, password)
VALUES ('PM_john', 'password');
...
VALUES ('EMP_bert', '123');
INSERT INTO Employees (username, password)
VALUES ('EMP_jane', 'pw_jane');
-- Added password

-- Projects (Assuming project_id will be 1 for Project Alpha, 2 for Project Beta)
INSERT INTO Projects (project_name, project_description, start_date, end_date, estimated_hours, actual_hours_used,
                      project_priority, project_status)
VALUES ('Project Alpha', 'This is a project description test', '2025-04-01', '2025-06-01', 120, 95, 'HIGH',
        'COMPLETED');
INSERT INTO Projects (project_name, project_description, start_date, end_date, estimated_hours, actual_hours_used,
                      project_priority, project_status)
...
INSERT INTO Subprojects (project_id, subproject_name, subproject_description, start_date, end_date, subproject_priority,
                         estimated_hours, actual_hours_used, subproject_status)
VALUES (1, 'Subproject A', 'Subproject test description', '2025-04-01', '2025-06-01', 'MEDIUM', 40, 38, 'COMPLETED');


-- Task 1
INSERT INTO Tasks (subproject_id, task_name, task_description, task_priority, estimated_hours, actual_hours_used,
                   task_status)
VALUES (1, 'Task Alpha', 'Design system architecture', 'HIGH', 10, 9, 'COMPLETED');

-- Task 2
INSERT INTO Tasks (subproject_id, task_name, task_description, task_priority, estimated_hours, actual_hours_used,
                   task_status)
VALUES (1, 'Task Beta', 'Implement login functionality', 'MEDIUM', 8, 8, 'COMPLETED');

-- Task 3
INSERT INTO Tasks (subproject_id, task_name, task_description, task_priority, estimated_hours, actual_hours_used,
                   task_status)
VALUES (1, 'Task Gamma', 'Write unit tests', 'LOW', 6, 4, 'IN_PROGRESS');

-- Task 4
INSERT INTO Tasks (subproject_id, task_name, task_description, task_priority, estimated_hours, actual_hours_used,
                   task_status)
VALUES (1, 'Task Delta', 'Fix bugs reported by QA', 'HIGH', 5, 0, 'PENDING');

-- Task 5
INSERT INTO Tasks (subproject_id, task_name, task_description, task_priority, estimated_hours, actual_hours_used,
                   task_status)
VALUES (1, 'Task Epsilon', 'Refactor database layer', 'MEDIUM', 7, 3, 'IN_PROGRESS');
