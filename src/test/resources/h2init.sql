    ...
    INSERT INTO Subprojects (project_id, subproject_name, subproject_description, start_date, end_date, subproject_priority, estimated_hours, actual_hours_used, subproject_status)
